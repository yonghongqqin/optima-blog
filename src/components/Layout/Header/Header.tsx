...
const HeaderDom = (props: IProps) => {
  const headerTitle = [
    { title: 'Home', icon: { __html: '&#xe600;' }, url: '/' },
    { title: 'Archives', icon: { __html: '&#xe660;' }, url: '/time-file' },
    { title: 'Say It', icon: { __html: '&#xe6a1;' }, url: '/say' },
    { title: 'favourite', icon: { __html: '&#xe60e;' }, url: '/collect' }
  ]
  const menu = (
    <Menu className="menu">
            ...
            <div className="header-logo-wrp">
              <div className="combined">
                ...
                <Texty
                  ...
                  delay={2200}
                  interval={30}>
                  Recording . my . learning . path, Stay . hungry
                </Texty>
              </div>
